...
1. Find the block that says ****OAuth Tokens and clickInstall to (workspace)****

![images/4.png](/images/4.png)

1. Verify **OnyxConnector **is in your workspace

![images/Screenshot2025-03-18132701.png](/images/Screenshot2025-03-18132701.png)

1. Revisit the **How it Works** at the top of this page to understand OnyxConnector's authorizations
